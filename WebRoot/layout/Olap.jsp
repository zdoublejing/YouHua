		...
		<div class="top">
  		...
  		<div id="MainMenu" class="ddsmoothmenu">
  			<ul>
	  			...
	  			<li><a href="_olap_page.jsp?query=olap" title="OLAP" id="menu_selected"><span>联机分析</span></a>
	  				<ul class="menulevel">
  		...
  		<div id="olap_main" class="clearfix">
  	    	<div class="olap-page-left">
  	    		<div style="cursor:pointer;" onclick="location.href='_olap_page.jsp'"><h2>Energy Olap</h2></div>
        		<div style="cursor:pointer;" onclick="location.href='###'"><h2>###</h2></div>
        		<div style="cursor:pointer;" onclick="location.href='###'"><h2>###</h2></div>		    		    
    		</div>
    	
    		<div class="olap-page-right">
      			<div class="olap-site-nav">
      			<span>当前位置 : </span>
      			<a href="index.jsp">公司主页</a> &gt;&gt; 
      			<a href="_olap_page.jsp?query=olap">联机分析</a>
      		</div>
