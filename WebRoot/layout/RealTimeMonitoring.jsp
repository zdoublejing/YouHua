		...
		<div class="top">
  		...
  		<div id="MainMenu" class="ddsmoothmenu">
  			<ul>
	  			...
	  			<li><a href=### title="实时监测" id="menu_selected"><span>实时监测</span></a><ul class="menulevel">
	  			...
	  			<li><a href="###" title="关于我们"><span>关于我们</span></a><ul class="menulevel">
  		...
  		<div id="rt_page_main" class="clearfix">
    		<div class="rt-page-right">
      			<div class="site-nav"><span>当前位置 : </span><a href="../index.jsp">公司主页</a> &gt;&gt; <a href="RTMindex.jsp" title="实时监测">实时监测</a></div>
    		...
    		<div class="rt-page-left">
				<div style="cursor:pointer;" onclick="location.href='../_RealTime/Day.jsp'"><h2>本日</h2></div>
        		<div style="cursor:pointer;" onclick="location.href='Month.jsp'"><h2>本月</h2></div>
        		<div style="cursor:pointer;" onclick="location.href='Year.jsp'"><h2>本年</h2></div>	
    		</div>
  		</div>
