  ...
  <body>
  	...
  	<div id="er_page_main" class="clearfix">
    	...
    	<div class="er-page-right">
      		...
      		<s:form action="OrgInfoAccountUpdate" namespace="/_EnergyReport" theme = "simple">
				<s:label>选择需要查询的年度</s:label>
				<s:select
				label="选择需要查询的年度" 
				list="orginfoaccount_recordyear" 
				name="orginfoaccount_recordyear_selected" 
				value="orginfoaccount_recordyear_selected" />
	  		...
	  		<!--<h1>总机构年度基本情况统计台帐（台账1表）</h1>
	  				-->
	  			<birt:viewer id="OrgInfoAccount"          
	    				pattern="frameset"
						reportDesign="OrgInfoAccount.rptdesign"
						title="Org Info Account"
						scrolling="true"
						position="relative"
						width="775"
						height="800"
					...
					<birt:param name="Year" value="${orginfoaccount_recordyear_selected}"/>
				</birt:viewer></div>	
