  	...
  	<div id="er_page_main" class="clearfix">
    	...
    	<div class="er-page-right">
      		...
      		<s:form action="OrgEnergyItemResultUpdate" namespace="/_EnergyReport" theme = "simple">
				...
				<s:select
				label="选择需要查询的年度" 
				list="orgenergyitemresult_recordyear" 
				name="orgenergyitemresult_recordyear_selected" 
				value="orgenergyitemresult_recordyear_selected" />
				<s:submit value="查询" name="submit"/>
			</s:form>
      		<br />
      		   		
      		<div class="page-reports">			    				
			<!--<h1>总机构（年、月、日）能耗资源消耗状态-（基2表）</h1>
					-->
				<birt:viewer id="OrgEnergyItemResult"
	    				pattern="frameset"
						reportDesign="OrgEnergyItemResult.rptdesign"
						title="Org Energy Item Result"
						scrolling="true"
						position="relative"
						width="775"
						height="800"
					...
					<birt:param name="Year" value="${orgenergyitemresult_recordyear_selected}"/>
				</birt:viewer></div>
