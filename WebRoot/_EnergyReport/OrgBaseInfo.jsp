  ...
  <body>
  	<div id="er_page_main" class="clearfix">
    	...
    	<div class="er-page-right">
      		...
      		<s:form action="OrgBaseInfoUpdate" namespace="/_EnergyReport" theme = "simple">
				<s:label>选择需要查询的年度</s:label>
				<s:select
				label="选择需要查询的年度" 
				list="orgbaseinfo_recordyear" 
				name="orgbaseinfo_recordyear_selected" 
				value="orgbaseinfo_recordyear_selected" />
				<s:submit value="查询" name="submit"/>
			</s:form>
      		<br />		
      		
      		<div class="page-reports">			    				
      			<birt:viewer id="OrgBaseInfo"
	    					pattern="frameset"
							reportDesign="OrgBaseInfo.rptdesign"
							title="Org Base Info"
							scrolling="true"
							position="relative"
							width="775"
					...
					<birt:param name="Year" value="${orgbaseinfo_recordyear_selected}"/>
				</birt:viewer>
			</div>
