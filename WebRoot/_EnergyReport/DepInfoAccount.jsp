  ...
  <body>
  	...
  	<div id="er_page_main" class="clearfix">
    	...
    	<div class="er-page-right">
      		...
      		<s:form action="DepInfoAccountUpdate" namespace="/_EnergyReport" theme = "simple">
      			<label>选择需要查询的年度</label>
				<s:select
				label="选择需要查询的年度" 
				list="depinfoaccount_recordyear" 
				name="depinfoaccount_recordyear_selected" 
				value="depinfoaccount_recordyear_selected" />&nbsp;			
	      		<label>选择需要查询的部门代码</label>
				<s:select
				label="选择需要查询的部门代码" 
				list="depinfoaccount_departid" 
				name="depinfoaccount_departid_selected" 
				value="depinfoaccount_departid_selected" />
      		...
      		<div class="page-reports">			
  				...
  				<!--<h1>部门年度基本情况统计台帐（台账1表）</h1>
  				-->
  				<birt:viewer id="DepInfoAccount"
	    			pattern="frameset"
					reportDesign="DepInfoAccount.rptdesign"
					title="Depart Info Account"
					scrolling="true"
					position="relative"
					width="775"
					height="800"
					...
					<birt:param name="Year" value="${depinfoaccount_recordyear_selected}"/>
					<birt:param name="DepId" value="${depinfoaccount_departid_selected}"/>
				</birt:viewer></div>
