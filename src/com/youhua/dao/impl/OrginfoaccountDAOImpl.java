...
import com.youhua.bean.energyreport.Orginfoaccount;
import com.youhua.dao.OrginfoaccountDAO;

/**
 * @see com.youhua.bean.energyreport.Orginfoaccount
 * @author MyEclipse Persistence Tools
 * @author jean
 */

public class OrginfoaccountDAOImpl extends HibernateDaoSupport implements OrginfoaccountDAO {
	private static final Logger log = LoggerFactory
			.getLogger(OrginfoaccountDAOImpl.class);
	// property constants
	...
	public List<Integer> initParam(String orgid) {
		...
		String hql = "select distinct recordYear from Orginfoaccount as model where model.orgId = ?";
	...
	public void save(Orginfoaccount transientInstance) {
		log.debug("saving Orginfoaccount instance");
		try {
	...
	public void delete(Orginfoaccount persistentInstance) {
		log.debug("deleting Orginfoaccount instance");
		try {
	...
	public Orginfoaccount findById(java.lang.Long id) {
		log.debug("getting Orginfoaccount instance with id: " + id);
		try {
			Orginfoaccount instance = (Orginfoaccount) getHibernateTemplate()
					.get("com.youhua.bean.Orginfoaccount", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Orginfoaccount instance) {
		log.debug("finding Orginfoaccount instance by example");
		try {
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding Orginfoaccount instance with property: "
				+ propertyName + ", value: " + value);
		try {
			String queryString = "from Orginfoaccount as model where model."
					+ propertyName + "= ?";
	...
	public List findAll() {
		log.debug("finding all Orginfoaccount instances");
		try {
			String queryString = "from Orginfoaccount";
	...
	public Orginfoaccount merge(Orginfoaccount detachedInstance) {
		log.debug("merging Orginfoaccount instance");
		try {
			Orginfoaccount result = (Orginfoaccount) getHibernateTemplate()
	...
	public void attachDirty(Orginfoaccount instance) {
		log.debug("attaching dirty Orginfoaccount instance");
		try {
	...
	public void attachClean(Orginfoaccount instance) {
		log.debug("attaching clean Orginfoaccount instance");
		try {
	...
	public static OrginfoaccountDAOImpl getFromApplicationContext(
			ApplicationContext ctx) {
		return (OrginfoaccountDAOImpl) ctx.getBean("OrginfoaccountDAO");
	}
